...
namespace AntennaHouseBusinessLayer.DataModuleCreation
{
    class NumericalIndex
    {
        ...
        public string Qpnha { get; set; }
        public string CatalogSeq { get; set; }
    }

    public class NumIndexDm : IBuildDm
    {
        string Location { get; }
        public List<string> DmFiles { get; }
        public XmlNode NumIndexRef { get; set;  }
        List<NumericalIndex> NumIndexList { get; }
        string PmFile { get; set; }

        public NumIndexDm(string xmlFolder)
        {
        ...
        public void buildDmFile(string xmlFolder)
        {
            ...
            headerPara.InnerText = "Quantity per NHA";
            ...
            headerPara1.InnerText = "Part Number";
            ...
            headerPara2.InnerText = "Disassembly Code-Item Number";
