...
{
    public class GetReferences : ExtensionFunctionDefinition
    {
        public override QName FunctionName
        {
            get { return new QName("http://some.namespace.com", "getReferences"); }
        }
        ...
        {
            return new GetReferencesCall();
        }
    }

    public class GetReferencesCall : ExtensionFunctionCall
    {
